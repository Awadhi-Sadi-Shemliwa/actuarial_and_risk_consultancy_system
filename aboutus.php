<?php
/**
 * ARC Enterprise Management System
 ...
 * - Professional branding consistent with ARC identity
 */
...
<head>
    ...
    <title>ARC EMS - About Us | Enterprise Management Solutions</title>
    <link rel="icon" href="uploads/systemlogo/arc.png">
    <meta name="description" content="ARC Enterprise Management System - Comprehensive business management solution for modern enterprises.">
    ...
    <div class="container">
        <div class="about-card">
            ...
            <div class="about-header">
                ...
                $logo_path = '';
                $possible_logo_paths = [
                    'uploads/systemlogo/arc.png',
                    'uploads/systemlogo/arc-logo.png',
                ...
                <div class="logo-container">
                    <?php if ($logo_exists): ?>
                        <img src="<?= htmlspecialchars($logo_path) ?>" alt="ARC" class="header-logo">
                    <?php else: ?>
                        <div class="logo-text">ARC EMS</div>
                        <span class="logo-sub">Actuarial and Risk Consulting</span>
                    <?php endif; ?>
                </div>
            ...
            <div class="about-content">
                ...
                <div class="footer-note">
                    <p>&copy; <?= date('Y') ?> ARC Enterprise Management System. All rights reserved.</p>
