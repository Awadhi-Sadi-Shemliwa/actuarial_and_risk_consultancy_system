...
<head>
    ...
    <title>ARC EMS | <?= ucfirst(str_replace('-', ' ', $current_page)) ?></title>
    <?php if ($logo_exists): ?>
    ...
    <style>
        ...
        * {
        ...
        .navbar-logo-text {
            ...
            font-size: 20px;
            font-weight: 800;
            background: linear-gradient(135deg, #d8b96a 0%, #c69a3f 100%);
            ...
            <a href="?page=home" class="navbar-logo">
                <?php if ($logo_exists): ?>
                    <div class="navbar-logo-wrapper">
                        <img src="<?= htmlspecialchars($logo_path) ?>" alt="ARC EMS" class="navbar-logo-img">
                    </div>
                <?php else: ?>
                    <div>
                        <div class="navbar-logo-text">ARC EMS</div>
                        <div class="navbar-logo-sub">Actuarial and Risk Consulting</div>
                    </div>
                <?php endif; ?>
            </a>
