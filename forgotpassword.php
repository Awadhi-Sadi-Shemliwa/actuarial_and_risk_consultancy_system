...
<head>
    ...
    <title>ARC EMS - Forgot Password</title>
    <?php if ($logo_exists): ?>
    ...
    <style>
        * {
        ...
        body {
            ...
            background: linear-gradient(135deg, #3d2914 0%, #7d5419 50%, #c69a3f 100%);
            padding: 20px;
    ...
    <div class="container">
        <div class="form-container">
            ...
            <div class="logo-container">
                <?php if ($logo_exists): ?>
                    <img src="<?= htmlspecialchars($logo_path) ?>" alt="ARC" class="logo">
                <?php else: ?>
