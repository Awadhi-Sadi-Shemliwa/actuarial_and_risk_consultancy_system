...
$default_settings = [
    // General Settings
    ['app_name', 'ARC EMS', 'text', 'Application Name', 'System name displayed in browser title and headers', null, 10],
    ...
    ['email_from_name', 'ARC EMS', 'text', 'Email From Name', 'Default sender name for system emails', null, 420]
];
